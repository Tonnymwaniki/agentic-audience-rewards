...
// Retired picker, kept reachable but unlinked. It used to analyze the newest five
// videos automatically when opened with ?autoAnalyze=true; that was removed with
// the Connect rework — analysis only ever starts from an explicit per-video click.
